      ...
      {activeTab !== 'hot' && (
        <div className="px-4 py-3 flex gap-2">
          <input
            ...
            placeholder="搜索知乎内容..."
            className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white placeholder-white/30 focus:outline-none focus:border-xh-btn/50"
          />
          <button
