        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <ScrollText className="w-4 h-4 text-[#e2b04a]" />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 rounded-xl bg-white/[0.04] border border-white/10 text-sm text-white/80 placeholder:text-white/20 focus:outline-none focus:border-[#e2b04a]/30"
                />
              </div>
                  ...
                  {CATEGORIES.map((c) => (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-xs border transition-colors ${
                        category === c
                          ? 'bg-[#e2b04a]/15 text-[#e2b04a] border-[#e2b04a]/30'
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2.5 rounded-xl bg-white/[0.04] border border-white/10 text-sm text-white/80 placeholder:text-white/20 focus:outline-none focus:border-[#e2b04a]/30 resize-none"
                />
              ...
              <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
                <div className="flex items-start gap-2">
                  <Sparkles className="w-3.5 h-3.5 text-[#e2b04a]/50 shrink-0 mt-0.5" />
              ...
              <button
                ...
                className="w-full py-3 rounded-xl bg-[#e2b04a]/15 text-[#e2b04a] text-sm font-medium border border-[#e2b04a]/20 disabled:opacity-30 disabled:cursor-not-allowed"
              >
                下一步：设定角色
              </button>
            </motion.div>
          ...
          {step === 2 && (
            ...
            >
              ...
              {roles.map((role, idx) => (
                ...
                >
                  ...
                  <input
                    ...
                    placeholder="角色名称"
                    className="w-full px-3 py-2 rounded-lg bg-white/[0.04] border border-white/10 text-sm text-white/80 placeholder:text-white/20 focus:outline-none focus:border-[#e2b04a]/30"
                  />
                  <input
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full px-3 py-2 rounded-lg bg-white/[0.04] border border-white/10 text-sm text-white/80 placeholder:text-white/20 focus:outline-none focus:border-[#e2b04a]/30 resize-none"
                  />
                </motion.div>
              ))}
              ...
              <div className="p-3 rounded-xl bg-white/[0.02] border border-white/5">
                <div className="flex items-start gap-2">
                  <AlertCircle className="w-3.5 h-3.5 text-[#e2b04a]/50 shrink-0 mt-0.5" />
                  <p className="text-xs text-white/30 leading-relaxed">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 rounded-xl bg-[#e2b04a]/15 text-[#e2b04a] text-sm font-medium border border-[#e2b04a]/20 disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center gap-1.5"
                >
                  {submitting ? (
                    <span className="w-4 h-4 border-2 border-[#e2b04a]/30 border-t-[#e2b04a] rounded-full animate-spin" />
                  ) : (
                    <>
