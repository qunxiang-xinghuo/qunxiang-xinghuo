      ...
      <div className="flex-1 flex items-center justify-center text-center px-6">
        <div>
          ...
          <button
            ...
            className="bg-gradient-to-r from-xh-accent to-rose-600 text-white px-6 py-3 rounded-xl font-medium shadow-lg"
          >
            重新浏览
          </button>
        </div>
    ...
    <div className="flex-1 relative px-4">
      ...
      <div className="flex items-center justify-center gap-6 pb-8 mt-4">
        ...
        <button
          ...
          className="w-16 h-16 rounded-full bg-gradient-to-r from-xh-accent to-rose-600 flex items-center justify-center text-white shadow-lg"
        >
