...
<label>APP_ID</label>
<input id="app_id" placeholder="输入 APP_ID">
<label>APP_KEY</label>
<input id="app_key" type="password" placeholder="输入 APP_KEY">
...
<script>
document.getElementById('app_id').value = localStorage.getItem('app_id') || '';
